...
- `level`
  ...
  > | E*CLASS*\* | Entry level for each passport type        |
  > | D*CLASS*\* | Beginner level for each passport type     |
  > | C*CLASS*\* | Intermediate level for each passport type |
  > | B*CLASS*\* | Advanced level for each passport type     |
  > | A*CLASS*\* | Expert level for each passport type       |
  > | S*CLASS*\* | Master level for each passport type       |
