    ...
    describe('TypeConstructors', () => {
        describe('createRouteId', () => {
            ...
            it('should throw for invalid route IDs', () => {
                ...
                expect(() => TypeConstructors.createRouteId(null as any)).toThrow(
                    'Invalid RouteId',
                );
                expect(() => TypeConstructors.createRouteId(undefined as any)).toThrow(
                    'Invalid RouteId',
                );
            });
        });
        ...
        describe('createTouristSpotId', () => {
            ...
            it('should throw for invalid tourist spot IDs', () => {
                expect(() => TypeConstructors.createTouristSpotId('')).toThrow(
                    'Invalid TouristSpotId',
                );
                expect(() => TypeConstructors.createTouristSpotId(null as any)).toThrow(
                    'Invalid TouristSpotId',
                );
            });
        });
        ...
        describe('createKeyword', () => {
            ...
            it('should throw for invalid keywords', () => {
                ...
                expect(() => TypeConstructors.createKeyword('a'.repeat(51))).toThrow(
                    'Invalid Keyword',
                );
            });
        });
        ...
        describe('createCoordinates', () => {
            ...
            it('should throw for invalid latitude', () => {
                expect(() => TypeConstructors.createCoordinates(91, 139)).toThrow(
                    'Invalid latitude',
                );
                expect(() => TypeConstructors.createCoordinates(-91, 139)).toThrow(
                    'Invalid latitude',
            ...
            it('should throw for invalid longitude', () => {
                expect(() => TypeConstructors.createCoordinates(35, 181)).toThrow(
                    'Invalid longitude',
                );
                expect(() => TypeConstructors.createCoordinates(35, -181)).toThrow(
                    'Invalid longitude',
        ...
        describe('createConfidenceScore', () => {
            ...
            it('should throw for invalid confidence scores', () => {
                expect(() => TypeConstructors.createConfidenceScore(-0.1)).toThrow(
                    'Invalid confidence score',
                );
                expect(() => TypeConstructors.createConfidenceScore(1.1)).toThrow(
                    'Invalid confidence score',
                );
            });
        });
