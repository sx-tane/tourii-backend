...
export class TestController {
	...
	@ApiResponse({
		...
		schema: {
			type: 'object',
			properties: {
				code: { type: 'string', example: TouriiBackendAppErrorType.E_TB_011.code },
				message: { type: 'string', example: TouriiBackendAppErrorType.E_TB_011.message },
				type: { type: 'string', example: TouriiBackendAppErrorType.E_TB_011.type },
			},
		},
	})
	testApiKey() {
	...
	@ApiResponse({
		...
		schema: {
			type: 'object',
			properties: {
				code: { type: 'string', example: TouriiBackendAppErrorType.E_TB_020.code },
				message: { type: 'string', example: TouriiBackendAppErrorType.E_TB_020.message },
				type: { type: 'string', example: TouriiBackendAppErrorType.E_TB_020.type },
			},
		},
	})
	@ApiResponse({
	...
	@ApiResponse({
		...
		schema: {
			type: 'object',
			properties: {
				code: { type: 'string', example: TouriiBackendAppErrorType.E_TB_022.code },
				message: { type: 'string', example: TouriiBackendAppErrorType.E_TB_022.message },
				type: { type: 'string', example: TouriiBackendAppErrorType.E_TB_022.type },
			},
		},
	})
	@ApiResponse({
