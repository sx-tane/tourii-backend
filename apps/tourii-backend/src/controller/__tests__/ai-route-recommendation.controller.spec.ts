...
describe('AiRouteRecommendationController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<AiRouteRecommendationController>(
      AiRouteRecommendationController,
    );
  ...
  describe('generateRouteRecommendations', () => {
    ...
    it('should handle validation errors from service', async () => {
      ...
      await expect(
        controller.generateRouteRecommendations(mockRequest),
    ...
    it('should handle mapper errors', async () => {
      jest
        .spyOn(AiRouteRecommendationMapper, 'toResponseDto')
        .mockImplementation(() => {
    ...
    it('should log request and completion information', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(
        'AI route recommendation request received',
        {
          keywords: mockRequest.keywords,
          mode: mockRequest.mode,
          region: mockRequest.region,
      ...
      expect(logSpy).toHaveBeenCalledWith(
        'AI route recommendation completed',
        {
          routesGenerated: 1,
          processingTime: 2500,
          userId: 'test-user',
    ...
    it('should log errors with context', async () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith(
        'AI route recommendation failed',
        {
          error: 'Test error',
          keywords: mockRequest.keywords,
          userId: 'test-user',
