...
export const StoryChapterCreateRequestSchema = z.object({
    ...
    chapterDesc: z.string().describe('Detailed description or content of the story'),
...
export class StoryChapterCreateRequestDto extends createZodDto(StoryChapterCreateRequestSchema) {}
