...
export const TouristSpotUpdateRequestSchema =
	TouristSpotCreateRequestSchema.extend({
		touristSpotId: z
			.string()
		...
		updUserId: z
			.string()
			.describe("Unique identifier for the user who updated the tourist spot"),
	});

export class TouristSpotUpdateRequestDto extends createZodDto(
