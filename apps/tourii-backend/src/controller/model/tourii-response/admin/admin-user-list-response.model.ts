...
export const AdminUserResponseSchema = z.object({
    ...
    userAchievements: UserAchievementResponseSchema.array().optional().describe('User achievements'),
    userOnchainItems: UserOnchainItemResponseSchema.array().optional().describe('User onchain items'),
    userItemClaimLogs: UserItemClaimLogResponseSchema.array().optional().describe('User item claim logs'),
    ...
    discordActivityLogs: DiscordActivityLogResponseSchema.array().optional().describe('Discord activity logs'),
    discordUserRoles: DiscordUserRolesResponseSchema.array().optional().describe('Discord user roles'),
    discordRewardedRoles: DiscordRewardedRolesResponseSchema.array().optional().describe('Discord rewarded roles'),
    ...
    }).optional().describe('Summary statistics for admin view'),
});
...
export const AdminUserQuerySchema = z.object({
    ...
    searchTerm: z.string().optional().describe('Search in username, email, discord/twitter usernames'),
    ...
    sortBy: z.enum(['username', 'registered_at', 'total_quest_completed', 'total_travel_distance']).optional().default('registered_at').describe('Sort field'),
