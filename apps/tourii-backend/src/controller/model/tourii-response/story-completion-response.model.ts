...
export const StoryCompletionResponseSchema = z.object({
    ...
    unlockedQuests: z
        .array(
            z.object({
                ...
                touristSpotName: z
                    .string()
                    .describe('Name of the tourist spot where the quest is located'),
                totalMagatamaPointAwarded: z
                    .number()
                    .describe('Total magatama points awarded for completing this quest'),
    ...
    rewards: z
        .object({
            magatamaPointsEarned: z
                .number()
                .describe('Total magatama points earned from story completion and achievements'),
            achievementsUnlocked: z
                .array(z.string())
                .describe('List of achievement names unlocked'),
        })
