export interface UserTaskLogRepository {
    ...
    submitSocialTaskForVerification(userId: string, taskId: string, proofUrl: string): Promise<void>;
    submitTextTaskForVerification(userId: string, taskId: string, textAnswer: string): Promise<void>;
