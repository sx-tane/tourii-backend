    ...
    it('returns top 3 most popular quests based on completed tasks', async () => {
        ...
        await prisma.user_task_log.createMany({
            data: [
                ...
                { user_id: 'user1', quest_id: 'quest1', task_id: 'task1', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user1', quest_id: 'quest1', task_id: 'task2', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user2', quest_id: 'quest1', task_id: 'task1', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user2', quest_id: 'quest1', task_id: 'task2', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user3', quest_id: 'quest1', task_id: 'task1', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user3', quest_id: 'quest1', task_id: 'task2', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                
                // quest2 completions (3 total - making it second most popular)
                { user_id: 'user1', quest_id: 'quest2', task_id: 'task3', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user2', quest_id: 'quest2', task_id: 'task3', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
                { user_id: 'user3', quest_id: 'quest2', task_id: 'task3', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },

                // qtask completions (1 total - making it third most popular)
                { user_id: 'user1', quest_id: 'qtask', task_id: 'tDel2', status: 'COMPLETED', action: 'CHECK_IN', group_activity_members: [] },
            ],
        });
