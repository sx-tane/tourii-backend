...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_t = typeof user_entity_1.UserEntity !== "undefined" && user_entity_1.UserEntity) === "function" ? _t : Object]),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_v = typeof login_request_model_1.LoginRequestDto !== "undefined" && login_request_model_1.LoginRequestDto) === "function" ? _v : Object]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_x = typeof auth_signup_request_model_1.AuthSignupRequestDto !== "undefined" && auth_signup_request_model_1.AuthSignupRequestDto) === "function" ? _x : Object, Object]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_0 = typeof quest_fetch_request_model_1.QuestListQueryDto !== "undefined" && quest_fetch_request_model_1.QuestListQueryDto) === "function" ? _0 : Object]),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_3 = typeof quest_update_request_model_1.QuestUpdateRequestDto !== "undefined" && quest_update_request_model_1.QuestUpdateRequestDto) === "function" ? _3 : Object]),
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_5 = typeof quest_task_update_request_model_1.QuestTaskUpdateRequestDto !== "undefined" && quest_task_update_request_model_1.QuestTaskUpdateRequestDto) === "function" ? _5 : Object]),
...
let TouriiBackendService = class TouriiBackendService {
    constructor(userRepository, storyRepository, modelRouteRepository, geoInfoRepository, weatherInfoRepository, questRepository, encryptionRepository, userStoryLogRepository, passportRepository) {
    ...
    async createModelRoute(modelRoute) {
        ...
        const touristSpotGeoInfoList = await this.geoInfoRepository.getGeoLocationInfoByTouristSpotNameList(modelRoute.touristSpotList.map((spot) => spot.touristSpotName));
        const regionInfo = await this.geoInfoRepository.getRegionInfoByRegionName(modelRoute.region);
        const modelRouteEntity = await this.modelRouteRepository.createModelRoute(model_route_create_request_builder_1.ModelRouteCreateRequestBuilder.dtoToModelRoute(modelRoute, storyEntity, touristSpotGeoInfoList, regionInfo, 'admin'));
    ...
    async createTouristSpot(touristSpotDto, modelRouteId) {
        ...
        const touristSpotEntityInstance = model_route_create_request_builder_1.ModelRouteCreateRequestBuilder.dtoToTouristSpot([touristSpotDto], [touristSpotGeoInfo], storyEntity, 'admin')[0];
...
exports.TouriiBackendService = TouriiBackendService = __decorate([
    ...
    __param(5, (0, common_1.Inject)(tourii_backend_constant_1.TouriiBackendConstants.QUEST_REPOSITORY_TOKEN)),
    __param(6, (0, common_1.Inject)(tourii_backend_constant_1.TouriiBackendConstants.ENCRYPTION_REPOSITORY_TOKEN)),
    __param(7, (0, common_1.Inject)(tourii_backend_constant_1.TouriiBackendConstants.USER_STORY_LOG_REPOSITORY_TOKEN)),
    __param(8, (0, common_1.Inject)(tourii_backend_constant_1.TouriiBackendConstants.DIGITAL_PASSPORT_REPOSITORY_TOKEN)),
    __metadata("design:paramtypes", [Object, Object, typeof (_a = typeof model_route_repository_1.ModelRouteRepository !== "undefined" && model_route_repository_1.ModelRouteRepository) === "function" ? _a : Object, typeof (_b = typeof geo_info_repository_1.GeoInfoRepository !== "undefined" && geo_info_repository_1.GeoInfoRepository) === "function" ? _b : Object, typeof (_c = typeof weather_info_repository_1.WeatherInfoRepository !== "undefined" && weather_info_repository_1.WeatherInfoRepository) === "function" ? _c : Object, typeof (_d = typeof quest_repository_1.QuestRepository !== "undefined" && quest_repository_1.QuestRepository) === "function" ? _d : Object, Object, typeof (_e = typeof user_story_log_repository_1.UserStoryLogRepository !== "undefined" && user_story_log_repository_1.UserStoryLogRepository) === "function" ? _e : Object, typeof (_f = typeof digital_passport_repository_1.DigitalPassportRepository !== "undefined" && digital_passport_repository_1.DigitalPassportRepository) === "function" ? _f : Object])
...
exports.QuestUpdateRequestSchema = zod_1.z.object({
    ...
    taskList: zod_1.z.array(quest_task_update_request_model_1.QuestTaskUpdateRequestSchema).optional().describe('List of tasks for the quest'),
});
